...
productRouter
  .get("/", get관리자로그인)
  .post(routes.productLogin, post관리자로그인);

// 관리자 회원가입
productRouter
  .get(routes.adminRegister, get관리자회원가입)
  .post(routes.adminRegister, post관리자회원가입);
...
productRouter.get(
  `${routes.productUser}/approve/:userID`,
  onlyAdmin,
  adminUserApprove
);
productRouter.get(
  `${routes.productUser}/delete/:userID`,
  onlyAdmin,
  adminUserDelete
);
